    ...
    <tbody>
        ...
        ?>
                <tr>
                    ...
                    <td>
                        <div>Asli: <del><?= number_to_currency($item['options']['original_price'], 'IDR') ?></del></div>
                        <div>Diskon: -<?= number_to_currency($item['options']['diskon'], 'IDR') ?></div>
                        <div><strong><?= number_to_currency($item['price'], 'IDR') ?></strong></div>
                    </td>
